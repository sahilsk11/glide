    ...
    <div className="experience-skill-insight">
      <div className="experience-skill-row">
        ...
        <p className="experience-eval-text">
          Glide regularly scans software enginnering job posts to determine top in demand skills. Consider adding to your skillset up by learning popular technologies from this <a href="https://www.ziprecruiter.com/Career/Software-Engineer/Resume-Keywords-and-Skills" className="glide-link" target="_blank">list</a>.
            <br /><br />
